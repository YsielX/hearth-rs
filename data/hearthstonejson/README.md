...
`selected.enUS.json` is the source snapshot for the 1,999 implemented official definitions as of 2026-08-30. It is derived from:
...
Every Lua definition under `data/sets/`, `data/hero_powers/`, and `data/heroes/` must resolve to an official ID in the selected snapshot. End-to-end tests compare metadata one by one.
