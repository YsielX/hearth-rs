...
local card = { api_version = 1, id = "UNG_001", name = "Pterrordax Hatchling", text = "<b><b>Battlecry:</b> Adapt</b>.",
    set = "UNGORO", type = "minion", rarity = "common", cost = 3, attack = 2, health = 2,
