...
function card.on_play(ctx,self) for _,e in ipairs(ctx:friendly_minions(self)) do ctx:attach_deathrattle(e,"UNG_956");ctx:grant_keyword(e,"deathrattle") end end
