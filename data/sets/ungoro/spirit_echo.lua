...
function card.on_play(ctx,self) for _,e in ipairs(ctx:friendly_minions(self)) do ctx:attach_hook(e, "on_deathrattle","UNG_956");cardlib.effects.grant_keyword(ctx, e,"deathrattle") end end
