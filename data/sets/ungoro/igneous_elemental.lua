...
function card.on_deathrattle(ctx,self) local p=ctx:controller(self);cardlib.effects.give_card(ctx, p,"UNG_809t1");cardlib.effects.give_card(ctx, p,"UNG_809t1") end
return card
