...
function card.on_battlecry(ctx,self) local targets={} for _,e in ipairs(ctx:minions()) do if ctx:entity(e).damage>0 then targets[#targets+1]=e end end ctx:destroy_all(targets) end
return card
