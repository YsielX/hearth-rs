...
function card.on_battlecry(ctx,self) local targets={} for _,e in ipairs(ctx:minions()) do if e~=self then targets[#targets+1]=e end end cardlib.effects.damage_all(ctx, targets,2) end
return card
