local card = { api_version = 1, id = "UNG_027", name = "Pyros",
    ...
    on_deathrattle = function(ctx, self) ctx:give_card(ctx:controller(self), "UNG_027t2") end }
card.tokens = {
    { id = "UNG_027t2", name = "Pyros", text = "<b>Deathrattle:</b> Return this to your hand as a 10/10 that costs (8).",
      ...
      on_deathrattle = function(ctx, self) ctx:give_card(ctx:controller(self), "UNG_027t4") end },
