...
function card.on_battlecry(ctx,self) for _,e in ipairs(ctx:hand(ctx:controller(self))) do if elemental(ctx,e) then ctx:modify(e,{stat="cost",operation="add",value=-1}) end end end
return card
