...
card.tokens = {
    ...
    { id = "WW_001t18", rarity = "common", name = "Pouch of Coins", text = "Get two Coins.", set = "WILD_WEST", type = "spell", cost = 1, on_play = function(ctx, self) local p = ctx:controller(self); ctx:give_card(p, "GAME_005"); ctx:give_card(p, "GAME_005") end },
