...
card.tokens = {
    { id = "WW_001t", name = "Rock", text = "Deal $3 damage.", set = "WILD_WEST", type = "spell", cost = 1, target_mode = "required", targets = function(ctx) return ctx:characters() end, on_play = function(ctx, self, target) cardlib.effects.damage(ctx, target, 3) end },
