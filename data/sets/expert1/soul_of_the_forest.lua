...
function card.on_play(ctx,self)for _,e in ipairs(ctx:friendly_minions(self))do ctx:attach_hook(e,"on_deathrattle","EX1_158");cardlib.effects.grant_keyword(ctx, e,"deathrattle")end end
function card.on_deathrattle(ctx,self,pos)cardlib.effects.summon_at(ctx, ctx:controller(self),"EX1_158t",pos)end
