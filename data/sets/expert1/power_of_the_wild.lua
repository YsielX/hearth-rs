local card={api_version=1,id="EX1_160",name="Power of the Wild",text="<b>Choose One -</b> Give your minions +1/+1; or Summon a 3/2 Panther.",set="EXPERT1",type="spell",class="druid",rarity="common",spell_school="nature",cost=2,keywords={"choose_one"}}
