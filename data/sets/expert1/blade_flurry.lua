...
function card.on_play(ctx,self)local w=ctx:player(ctx:controller(self)).weapon;if w then local a=ctx:entity(w).attack;cardlib.effects.destroy(ctx, w);cardlib.effects.damage_all(ctx, ctx:enemy_minions(self),a)end end
return card
