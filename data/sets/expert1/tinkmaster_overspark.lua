...
function card.tink_form(ctx,self,id)local target=ctx:get_data(self,"tink_target");if target and ctx:entity(target).zone=="board"then cardlib.effects.transform(ctx, target,id)end end
