...
function card.wrath_hit(ctx,self,target)cardlib.effects.damage_ignoring_spell_damage(ctx, target,1);ctx:set_data(self,"hits_left",ctx:get_data(self,"hits_left")-1);ctx:continue_with("wrath_continue")end
