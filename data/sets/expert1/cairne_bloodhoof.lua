local card={api_version=1,id="EX1_110",name="Cairne Bloodhoof",text="[x]<b>Taunt</b>\n<b>Deathrattle:</b> Summon a\n5/5 Baine Bloodhoof.",set="EXPERT1",type="minion",rarity="legendary",cost=6,attack=5,health=5,keywords={"taunt","deathrattle"},on_deathrattle=function(ctx,self,pos)ctx:summon_at(ctx:controller(self),"EX1_110t",pos)end}
