...
function card.chosen(ctx,self,c)local t=ctx:get_data(self,"wrath_target");ctx:damage(t,c==1 and 3 or 1);if c==2 then ctx:draw(ctx:controller(self),1)end end
function card.on_choose_multiple(ctx,self,target)ctx:damage(target,4);ctx:draw(ctx:controller(self),1)end
return card
