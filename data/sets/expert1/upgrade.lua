...
function card.on_play(ctx,self)local p=ctx:controller(self);local w=ctx:player(p).weapon;if w then ctx:buff(w,1,1)else ctx:equip_weapon(p,"EX1_409t")end end
