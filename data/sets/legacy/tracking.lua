local card={api_version=1,id="DS1_184", rarity = "free",name="Tracking",text="<b>Discover</b> a card from your deck.",set="LEGACY",type="spell",class="hunter",cost=1,keywords={"discover"}}
