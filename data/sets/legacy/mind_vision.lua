local card={api_version=1,id="CS2_003",name="Mind Vision",text="Put a copy of a random card in your opponent's hand into your hand.",set="LEGACY",type="spell",class="priest",spell_school="shadow",cost=1,rules={can_play=function(ctx,self,current)local p=ctx:opponent(ctx:controller(self));return current and #ctx:hand(p)>0 end}}
