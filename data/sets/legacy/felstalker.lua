local card={api_version=1,id="EX1_306",name="Felstalker",text="<b>Battlecry:</b> Discard a random card.",set="LEGACY",type="minion",class="warlock",cost=2,attack=4,health=3,tags={"demon"},keywords={"battlecry"}}
