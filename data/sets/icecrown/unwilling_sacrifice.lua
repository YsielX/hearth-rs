...
function card.on_play(ctx,self,target)ctx:destroy(target);ctx:continue_with("destroy_random_enemy")end
...
function card.sacrifice_enemy(ctx,self,target)ctx:destroy(target)end
return card
