...
function card.on_battlecry(ctx,self)local n=#ctx:minions_died_this_turn(0)+#ctx:minions_died_this_turn(1);if n>0 then cardlib.effects.buff(ctx, self,n,n)end end
return card
