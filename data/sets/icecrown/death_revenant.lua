...
function card.on_battlecry(ctx,self)local n=0;for _,e in ipairs(ctx:minions())do if ctx:entity(e).damage>0 then n=n+1 end end;if n>0 then cardlib.effects.buff(ctx, self,n,n)end end
return card
