...
function card.on_battlecry(ctx,self,target)if target then cardlib.effects.destroy(ctx, target);ctx:continue_with("revel")end end
function card.revel(ctx,self)if ctx:entity(self).zone=="board"then cardlib.effects.buff(ctx, self,2,2)end end
return card
