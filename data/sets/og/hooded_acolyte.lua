...
function card.buff_cthun(ctx,self)local p=ctx:controller(self);ctx:grant_player_keyword(p,"cthun_buffs");ctx:increment_player_data(p,"public:cthun_attack_buff",1);ctx:increment_player_data(p,"public:cthun_health_buff",1)end
return card
