...
function card.kobold_missile_hit(ctx,self,target)cardlib.effects.damage(ctx, target,1);local n=ctx:get_data(self,"kobold_missiles")-1;ctx:set_data(self,"kobold_missiles",n);if n>0 then ctx:continue_with("fire_kobold_missile")end end
return card
