...
function card.on_deathrattle(ctx,self,position)local p=ctx:controller(self);for i=1,7 do cardlib.effects.summon_at(ctx, p,"LOOT_153t1",position+i-1)end end
