local card={api_version=1,id="LOOT_314",name="Grizzled Guardian",text="<b>Taunt</b>\n<b>Deathrattle:</b> <b>Recruit</b> 2 minions that cost (4) or less.",set="LOOTAPALOOZA",type="minion",class="druid",rarity="rare",cost=8,attack=3,health=5,tags={"beast"},keywords={"taunt","deathrattle","recruit"}}
