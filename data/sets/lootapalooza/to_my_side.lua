local card={api_version=1,id="LOOT_217",name="To My Side!",text="[x]Summon an Animal\nCompanion, or 2 if your\ndeck has no minions.",set="LOOTAPALOOZA",type="spell",class="hunter",rarity="epic",cost=6}
