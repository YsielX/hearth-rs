local card={api_version=1,id="LOOT_184",name="Silver Vanguard",text="<b>Deathrattle:</b> <b>Recruit</b> an 8-Cost minion.",set="LOOTAPALOOZA",type="minion",rarity="common",cost=7,attack=3,health=3,keywords={"deathrattle","recruit"}}
