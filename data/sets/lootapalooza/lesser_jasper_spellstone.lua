local function stone(id,name,text,damage,next_id)
 local x={id=id,name=name,text=text,set="LOOTAPALOOZA",type="spell",class="druid",collectible=false,rarity="rare",spell_school="nature",cost=1,target_mode="required",targets=function(ctx)return ctx:minions()end,on_play=function(ctx,self,target)ctx:damage(target,damage)end}
