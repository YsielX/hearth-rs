...
local card={api_version=1,id="LOOT_026",name="Fal'dorei Strider",text="<b>Battlecry:</b> Shuffle 3 Ambushes into your deck. When drawn, summon a 4/4 Spider.",set="LOOTAPALOOZA",type="minion",class="rogue",rarity="epic",cost=4,attack=4,health=4,keywords={"battlecry"}}
