...
function card.on_battlecry(ctx,self)local p=ctx:controller(self);cardlib.effects.shuffle_card_into_deck(ctx, p,"LOOT_026e");cardlib.effects.shuffle_card_into_deck(ctx, p,"LOOT_026e");cardlib.effects.shuffle_card_into_deck(ctx, p,"LOOT_026e")end
