...
return {
    api_version = 1, module_type = "keyword", id = "honorable_kill", name = "Honorable Kill",
    required_card_hooks = { "on_honorable_kill" },
    triggers = {
        {
            ...
            effect = function(ctx, self, event)
                ctx:continue_with_entity("on_honorable_kill", event.target)
            end,
        },
    },
}
