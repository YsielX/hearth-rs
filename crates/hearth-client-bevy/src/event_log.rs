...
use crate::i18n::{outcome_label, pick, player_label};
...
pub fn event_summary(
    ...
    let player = |id| player_label(locale, id, viewer);
    let card = |entity: &PublicEntity| session.card_name(&entity.card_id);
